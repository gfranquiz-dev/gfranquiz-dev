...
- **Programming Languages:** 
    - Python (Core logic, control flow, data structures).
    - Learning: HTML, C++ and JavaScript.
- **Tools & Ecosystem:** 
    - About coding: Git, GitHub, VS Code, Linux (Ubuntu)
    - Mastered tools: 
...
![Visitas al perfil](https://komarev.com/ghpvc/?username=gfranquiz-dev&color=green&style=flat-square)
